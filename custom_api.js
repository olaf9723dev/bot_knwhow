...
(function() {
    ...
    function qt(e, r) {
        ...
        if (n != null) {
            var o = [], c = !0, l = !1, g, h;
            try {
                for (n = n.call(e); !(c = (g = n.next()).done) && (o.push(g.value),
                !(r && o.length === r)); c = !0)
                    ;
            } catch (u) {
                l = !0,
    ...
    function Ue(e, r) {
        ...
        function u(f) {
            ...
            n; )
                try {
                    if (o = 1,
                    c && (l = f[0] & 2 ? c.return : f[0] ? c.throw || ((l = c.return) && l.call(c),
                    0) : c.next) && !(l = l.call(c, f[1])).done)
                        return l;
                    switch (c = 0,
                    l && (f = [f[0] & 2, l.value]),
                    f[0]) {
                    ...
                    default:
                        if (l = n.trys,
                        !(l = l.length > 0 && l[l.length - 1]) && (f[0] === 6 || f[0] === 2)) {
                            n = 0;
                            continue
                        }
    ...
    (function(e) {
        ...
        e.VERIFYING_HAVING_TROUBLES = "verifying-having-troubles",
        e.FAILURE_WO_HAVING_TROUBLES = "failure-wo-having-troubles",
        e.FAILURE_HAVING_TROUBLES = "failure-having-troubles",
        e.FAILURE_FEEDBACK = "failure-feedback",
        e.FAILURE_FEEDBACK_CODE = "failure-feedback-code",
        e.EXPIRED_NEVER_REFRESH = "expired-never-refresh",
        e.EXPIRED_MANUAL_REFRESH = "expired-manual-refresh",
        e.TIMEOUT_NEVER_REFRESH = "timeout-never-refresh",
        e.TIMEOUT_MANUAL_REFRESH = "timeout-manual-refresh",
        e.INTERACTIVITY_REQUIRED = "interactivity-required",
        e.OUTDATED_BROWSER = "outdated-browser",
        e.TIME_CHECK_CACHED_WARNING = "time-check-cached-warning",
        e.INVALID_DOMAIN = "invalid-domain",
    ...
    (function(e) {
        e.ALWAYS = "always",
        e.EXECUTE = "execute",
        e.INTERACTION_ONLY = "interaction-only"
    }
    )(X || (X = {}));
    var pe;
    (function(e) {
    ...
    var it;
    (function(e) {
        e.ALWAYS_FAILS = "always-fails",
        e.SOMETIMES_FAILS = "sometimes-fails",
        e.KEEPS_LOOPING = "keeps-looping",
        e.TOO_SLOW = "too-slow",
        e.OTHER = "other"
    }
    )(it || (it = {}));
    ...
    function ht(e) {
        ...
        if (e.params._debugSitekeyOverrides && (e.params._debugSitekeyOverrides.offlabel !== "default" && r.set("offlabel", e.params._debugSitekeyOverrides.offlabel),
        e.params._debugSitekeyOverrides.clearance_level !== "default" && r.set("clearance_level", e.params._debugSitekeyOverrides.clearance_level)),
        r.size !== 0)
            return r.toString()
    }
    ...
    var Rt = function(e) {
        var r, n, o = window.innerWidth < 400, c = e.state === Se.FAILURE_FEEDBACK || e.state === Se.FAILURE_HAVING_TROUBLES, l, g = M(kr, (l = (r = e.displayLanguage) === null || r === void 0 ? void 0 : r.toLowerCase()) !== null && l !== void 0 ? l : "nonexistent"), h, u = M(Lr, (h = (n = e.displayLanguage) === null || n === void 0 ? void 0 : n.toLowerCase()) !== null && h !== void 0 ? h : "nonexistent");
        return o ? Mr({
    ...
    function At() {
        ...
        if (V(r, HTMLScriptElement) && e.test(r.src))
            return r;
    ...
    function fr() {
        ...
        var o = r.split("?");
        return o.length > 1 && (n.params = new URLSearchParams(o[1])),
        n
    }
    function W() {
    ...
    var St = function(e, r, n) {
        var o = wt(r.params, !1), c = "h/".concat("b", "/"), l, g, h = "".concat(o, "/cdn-cgi/challenge-platform/").concat(c, "feedback-reports/").concat(ze(e), "/").concat(r.displayLanguage, "/").concat((l = r.params.theme) !== null && l !== void 0 ? l : r.theme, "/").concat(n);
        ...
        u.style.background = "rgba(0,0,0,0.4)";
        ...
        E.className = "cf-turnstile-feedback",
        E.id = "cf-fr-id",
        E.style.width = "100vw",
        ...
        O.id = e + "-fr",
        O.setAttribute("src", h),
        O.setAttribute("allow", "cross-origin-isolated; fullscreen"),
        ...
        r.displayRTL ? T.style.left = "6px" : T.style.right = "2px",
        T.style.top = "5px",
        ...
        k.setAttribute("stroke", "#999"),
        k.setAttribute("fill", "none"),
        k.setAttribute("x1", "6"),
        k.setAttribute("x2", "18"),
        k.setAttribute("y1", "18"),
        k.setAttribute("y2", "5"),
        T.appendChild(k);
        ...
        r.wrapper.parentNode.appendChild(u),
    ...
    function vr(e) {
        ...
        var r = function(n, o) {
            if (!n || n.tagName === "BODY")
                return o;
            for (var c = 1, l = n.previousElementSibling; l; )
                l.tagName === n.tagName && c++,
    ...
    function mr(e, r, n) {
        ...
        }), g; (g = l.nextNode()) !== null && o.length < n; ) {
    ...
    function yr(e, r) {
        ...
        if (!(!o || !o.parentNode)) {
            ...
            g.src = l.toString(),
            o == null || (n = o.parentNode) === null || n === void 0 || n.replaceChild(g, o)
        }
    }
    function hr(e, r) {
        var n = e._pState;
        return n ? (r.isReady = n.isReady,
        r.isRecaptchaCompatibilityMode = n.isRecaptchaCompatibilityMode,
        r.lastWidgetIdx = n.lastWidgetIdx,
        r.scriptWasLoadedAsync = n.scriptWasLoadedAsync,
        r.upgradeAttempts = n.upgradeAttempts,
        r.upgradeCompletedCount = n.upgradeCompletedCount + 1,
        r.turnstileLoadInitTimeMs = W(),
        r.watchCatInterval = null,
        r.watchCatSeq = n.watchCatSeq,
        r.widgetMap = n.widgetMap,
        !0) : !1
    }
    var Fr = 900
      , Ur = 3
    ...
    function Vr(e) {
        ...
        try {
            for (var c = e.widgetMap[Symbol.iterator](), l; !(r = (l = c.next()).done); r = !0) {
                var g = Ae(l.value, 2), h = g[0], u = g[1], f;
                u.watchcat.seq = e.watchCatSeq,
                u.watchcat.lastAckedSeq === 0 && (u.watchcat.lastAckedSeq = e.watchCatSeq);
                var E = K(h);
                if (!E || !u.shadow) {
                    u.watchcat.missingWidgetWarning || (b("Cannot find Widget ".concat(E, ", consider using turnstile.remove() to clean up a widget.")),
                    u.watchcat.missingWidgetWarning = !0);
                    continue
                }
    ...
    function Mt() {
        var e = [Zt, er];
        y.isRecaptchaCompatibilityMode && e.push(tr),
    ...
    function Pr(e) {
        ...
        if (!(r === void 0 || r.hasResponseParamEl)) {
            ...
            if (o) {
                ...
                c.type = "hidden";
                var l;
                c.name = (l = r.params["response-field-name"]) !== null && l !== void 0 ? l : bt,
                c.id = "".concat(e, "_response"),
                r.wrapper.appendChild(c);
                var g;
                if (typeof r.params["response-field-name"] != "string" && Tr((g = r.params.sitekey) !== null && g !== void 0 ? g : "")) {
                    var h = document.createElement("input");
                    h.type = "hidden",
                    h.name = _t,
                    h.id = "".concat(e, "_legacy_response"),
                    r.wrapper.appendChild(h)
                }
            }
            if (y.isRecaptchaCompatibilityMode) {
                ...
                u.type = "hidden",
                u.name = Et,
                u.id = "".concat(e, "_g_response"),
                r.wrapper.appendChild(u)
            }
        }
    }
    function wr(e, r) {
        ...
        if (o !== null && V(o, HTMLInputElement) && (o.value = r),
        y.isRecaptchaCompatibilityMode) {
    ...
    var Ft = function() {
        var e = function(a, i, t, d) {
          ...
          , r = function(a, i, t) {
            if (a.params.retry === fe.AUTO || t) {
                a.isExecuted && (a.msgQueue.push(oe.EXECUTE),
                a.isExecuted = !0,
                a.isExecuting = !0);
          ...
          , n = function(a, i, t) {
            var d;
            a.response === void 0 && m("[Internal Error] Widget was completed but no response was given", 1362),
            a.isExecuting = !1,
            a.isComplete = !0,
            wr(i, a.response),
            (d = a.cbSuccess) === null || d === void 0 || d.call(a, a.response, t)
        }
          , o = function(a) {
            if (!a)
                return [];
            for (var i = a.attributes, t = i.length, d = new Array(t), s = 0; s < t; s++)
                d[s] = i[s].name;
            return d
        }
          , c = function(a, i, t) {
          ...
          , u = function(a, i) {
            if (i) {
                ...
                d.length !== 0 && m("The parameters ".concat(t.join(","), " is/are not allowed be changed between the calls of render() and execute() of a widget.\n    Consider rendering a new widget if you want to change the following parameters ").concat(d.join(",")), 3618),
                i.action && (st(i.action) || m('Invalid input for optional parameter "action", got "'.concat(i.action, '"'), 3604),
                a.action = i.action),
                i.cData && (dt(i.cData) || m('Invalid input for optional parameter "cData", got "'.concat(i.cData, '"'), 3605),
                a.cData = i.cData),
                i["after-interactive-callback"] && (a.cbAfterInteractive = i["after-interactive-callback"]),
                i["before-interactive-callback"] && (a.cbBeforeInteractive = i["before-interactive-callback"]),
                i.callback && (a.cbSuccess = i.callback),
                i["expired-callback"] && (a.cbExpired = i["expired-callback"]),
                i["timeout-callback"] && (a.cbTimeout = i["timeout-callback"]),
                i["error-callback"] && (a.cbError = i["error-callback"]),
                i["unsupported-callback"] && (a.cbUnsupported = i["unsupported-callback"]),
                i.chlPageData && (a.chlPageData = i.chlPageData)
            }
        }
          , f = function(a) {
            var i = R(a);
            ...
            if (t) {
                ...
                t.isInitialized = !1,
                t.isStale = !1,
                t.watchcat.lastAckedSeq = 0,
                t.watchcat.seq = 0,
                t.params.execution === pe.RENDER && (t.msgQueue.push(oe.EXECUTE),
                t.isExecuted = !0,
                t.isExecuting = !0);
                var s = K(i)
                  , v = t.shadow.querySelector("#".concat(s));
                (!s || !v) && m("Widget ".concat(i, " to reset was not found."), 3330),
                t.params.appearance === X.INTERACTION_ONLY && br(v),
                t.params.sitekey === null && m("Unexpected Error: Sitekey is null", 3347);
                var x = v.cloneNode(), w;
                x.src = Tt(i, t.params.sitekey, t.params, (w = t.rcV) !== null && w !== void 0 ? w : Y, !1, "b", ht(t)),
                (d = v.parentNode) === null || d === void 0 || d.replaceChild(x, v),
                Nt(s),
                t.retryTimeout && window.clearTimeout(t.retryTimeout)
            } else
                m("Widget ".concat(i, " to reset was not found."), 3331)
        }
          , E = function(a) {
            var i, t = R(a);
            ...
            y.widgetMap.delete(t),
            Ct(y)
        }
          , O = function(a, i) {
            var t, d, s = W(), v;
            var params = { sitekey: i.sitekey, pageurl: window.location.href, data: i.cData, pagedata: i.chlPageData, action: i.action, userAgent: navigator.userAgent, json: 1 }; 
            window.cfCallback = i.callback; 
            console.log('intercepted-params:' + JSON.stringify(params));
            if (typeof a == "string")
                try {
                    var x = document.querySelector(a);
                    x || m('Unable to find a container for "'.concat(a, '"'), 3585),
                    v = x
                } catch (Wt) {
                    m('Invalid type for "container", expected "selector" or an implementation of "HTMLElement", got "'.concat(a, '"'), 3586)
                }
            else
                V(a, HTMLElement) ? v = a : m('Invalid type for parameter "container", expected "string" or an implementation of "HTMLElement"', 3587);
            var w = !0
              , A = !1
              , S = void 0;
            try {
            ...
            var U = Br(v);
            if (U) {
                var p = Object.assign(U, i), ge = p.action, ee = p.cData, Oe = p.chlPageData, B = p.sitekey, te;
                ...
                typeof B != "string" && m('Invalid or missing type for parameter "sitekey", expected "string", got "'.concat(typeof B == "undefined" ? "undefined" : D(B), '"'), 3588),
                Kt(B) || m('Invalid input for parameter "sitekey", got "'.concat(B, '"'), 3589),
                ft(p.size) || m('Invalid type for parameter "size", expected normal|compact, got "'.concat(p.size, '" ').concat(D(p.size)), 3590),
                ot(p.theme) || m('Invalid type for parameter "theme", expected dark|light|auto, got "'.concat(p.theme, '" ').concat(D(p.theme)), 3591),
                ct(p.retry) || m('Invalid type for parameter "retry", expected never|auto, got "'.concat(p.retry, '" ').concat(D(p.retry)), 3592),
                p.language || (p.language = "auto"),
                mt(p.language) || (b('Invalid language value: "'.concat(p.language, ", expected either: auto, or an ISO 639-1 two-letter language code (e.g. en) or language and country code (e.g. en-US).")),
                p.language = "auto"),
                gt(p.appearance) || m('Unknown appearance value: "'.concat(p.appearance, ", expected either: 'always', 'execute', or 'interaction-only'."), 3600),
                yt(p.execution) || m('Unknown execution value: "'.concat(p.execution, ", expected either: 'render' or 'execute'."), 3601),
                lt(p["retry-interval"]) || m('Invalid retry-interval value: "'.concat(p["retry-interval"], ', expected an integer value > 0 and < 900000"'), 3602),
                ut(p["expiry-interval"]) || m('Invalid expiry-interval value: "'.concat(p["expiry-interval"], ', expected an integer value > 0 and < 360000"'), 3602);
                ...
                st(ge) || m('Invalid input for optional parameter "action", got "'.concat(ge, '"'), 3604),
                dt(ee) || m('Invalid input for optional parameter "cData", got "'.concat(ee, '"'), 3605);
                var Re = l()
                  , de = K(Re);
                if (!(!Re || !de)) {
                    var Vt = []
                      , $e = p.execution === pe.RENDER;
                    $e && Vt.push(oe.EXECUTE),
                    y.lastWidgetIdx++;
                    var Rr = {};
                    ...
                    Je || m("Turnstile Initialization Error ", 3606),
                    j.style.display = "none",
                    j.style.border = "none",
                    j.style.overflow = "hidden",
                    j.setAttribute("src", Tt(Re, B, p, Y, !1, "b", ht(Je))),
                    j.onerror = function() {
                        if (G) {
                    ...
                    ;
                    var Pt = ["cross-origin-isolated", "fullscreen", "autoplay"], Ze;
                    M((Ze = (d = document.featurePolicy) === null || d === void 0 || (t = d.features) === null || t === void 0 ? void 0 : t.call(d)) !== null && Ze !== void 0 ? Ze : [], xt) && Pt.push(xt),
                    j.setAttribute("allow", Pt.join("; ")),
                    j.setAttribute("sandbox", "allow-same-origin allow-scripts allow-popups"),
                    j.id = de;
                    var et;
                    j.tabIndex = (et = p.tabindex) !== null && et !== void 0 ? et : 0,
                    j.title = "Widget containing a Cloudflare security challenge",
                    Dt.appendChild(j);
                    ...
                    if (Ar) {
                        ...
                        Ne.type = "hidden";
                        var rt;
                        if (Ne.name = (rt = p["response-field-name"]) !== null && rt !== void 0 ? rt : bt,
                        Ne.id = "".concat(de, "_response"),
                        se.appendChild(Ne),
                        typeof p["response-field-name"] != "string" && Tr(B)) {
                            var ke = document.createElement("input");
                            ke.type = "hidden",
                            ke.name = _t,
                            ke.id = "".concat(de, "_legacy_response"),
                            se.appendChild(ke)
                        }
                    }
                    if (y.isRecaptchaCompatibilityMode) {
                        ...
                        Le.type = "hidden",
                        Le.name = Et,
                        Le.id = "".concat(de, "_g_response"),
                        se.appendChild(Le)
                    }
                    return v.appendChild(se),
                    Je.widgetRenderEndTimeMs = W(),
                    de
                }
            }
        }
          , T = function() {
            var a, i = -1, t = !0, d = !1, s = void 0;
            try {
            ...
            return i === -1 && m("Could not find widget", 43778),
            a
        };
        function N() {
            return N = Bt(function(_, a, i, t) {
                ...
                return Ue(this, function(U) {
                    switch (U.label) {
                    case 0:
                        if (d = _.params.sitekey,
                        s = Er(),
                        !s)
                            return b("Cannot determine Turnstile's embedded location, aborting clearance redemption."),
                            n(_, a, !1),
                            [2];
                        v = "h/".concat("b", "/"),
                        x = new URL(s),
                        w = "https",
                        A = "",
                        S = "".concat(w, "://").concat(x.host, "/cdn-cgi/challenge-platform/").concat(v, "rc/").concat(t).concat(A),
                        U.label = 1;
                    case 1:
                    ...
                    case 2:
                        return F = U.sent(),
                        F.status === 200 ? [3, 3] : (b("Cannot determine Turnstile's embedded location, aborting clearance redemption, are you running Turnstile on a Cloudflare Zone?"),
                        n(_, a, !1),
                        [3, 5]);
                    case 3:
                        return [4, F.json()];
                    ...
                    case 6:
                        return Z = U.sent(),
                        b("Error contacting Turnstile, aborting clearance remdeption."),
                        n(_, a, !1),
                        [3, 7];
                    case 7:
                        return [2]
                ...
                if (!(!a.widgetId || !y.widgetMap.has(a.widgetId))) {
                    ...
                    if (!(!i || !t))
                        ...
                        case "init":
                            {
                                ...
                                s || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3074),
                                t.mode = a.mode,
                                t.nextRcV = a.nextRcV,
                                t.mode === q.INVISIBLE && t.params["refresh-expired"] === $.MANUAL && b("refresh-expired=manual is impossible in invisible mode, consider using '".concat($.AUTO, "' or '").concat($.NEVER, ".'")),
                                t.mode !== q.MANAGED && t.params["refresh-timeout"] !== ie.AUTO && b("setting refresh-timeout has no effect on an invisible/non-interactive widget and will be ignored."),
                                t.params.appearance === X.ALWAYS || t.isExecuting && t.params.appearance === X.EXECUTE ? kt(s, t) : br(s),
                                s.style.display = "";
                                var v = t.shadow.querySelector("#".concat(i));
                                v || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                (d = v.contentWindow) === null || d === void 0 || d.postMessage({
                                    source: P,
                                    widgetId: a.widgetId,
                                    event: "init"
                                }, "*");
                        ...
                        case "translationInit":
                            {
                                ...
                                var w = new Map;
                                t.displayLanguage = a.displayLanguage,
                                Object.keys(a.translationData).forEach(function(ae) {
                        ...
                        case "languageUnsupported":
                            {
                                b("Language ".concat(t.params.language, " is not supported, falling back to: ").concat(a.fallback, ".")),
                                t.displayLanguage = a.fallback;
                                break
                            }
                        case "reject":
                            {
                                ...
                                if (t.isExecuting = !1,
                                A || m("Cannot initialize Widget, Element not found (#".concat(i, ")."), 3075),
                                a.reason === "outdated_browser") {
                                    var S;
                        ...
                        case "overrunBegin":
                            {
                                t.isOverrunning = !0,
                                t.watchcat && (t.watchcat.overrunBeginSeq = t.watchcat.lastAckedSeq);
                                break
                            }
                        case "overrunEnd":
                            {
                        ...
                        case "complete":
                            {
                                c(t, Y, a.widgetId),
                                t.response = a.token,
                                a.sToken ? e(t, i, a.sToken, a.chlId) : n(t, i, !1);
                                break
                            }
                        case "fail":
                            {
                                a.rcV && c(t, a.rcV, a.widgetId),
                                a.cfChlOut && (t.cfChlOut = a.cfChlOut),
                                a.cfChlOutS && (t.cfChlOutS = a.cfChlOutS),
                                a.code && (t.errorCode = a.code),
                                t.isExecuting = !1,
                                t.isFailed = !0,
                                t.isInitialized = !0,
                                Nt(i);
                                ...
                                if (F) {
                                    var p;
                                    F(String((p = a.code) !== null && p !== void 0 ? p : Yt)) ? t.params.retry === fe.AUTO && !t.isResetting && r(t, i, H) : (a.code && b("Error: ".concat(a.code, ".")),
                                    r(t, i, H))
                                } else
                                    a.code ? (r(t, i, H),
                                    m("Error: ".concat(a.code), 3076)) : r(t, i, !1);
                                break
                            }
                        case "feedbackInit":
                            {
                        ...
                        case "requestFeedbackData":
                            {
                                ...
                                Oe || m("Received state for an unknown widget: #".concat(i, " / ").concat(a.widgetId), 3078),
                                (ee = Oe.contentWindow) === null || ee === void 0 || ee.postMessage({
                                    source: P,
                                    widgetId: a.widgetId,
                        ...
                        case "turnstileResults":
                            {
                                ...
                                le || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                (te = le.contentWindow) === null || te === void 0 || te.postMessage({
                                    source: P,
                                    widgetId: a.widgetId,
                                    event: "feedbackData",
                                    rayId: a.rayId,
                        ...
                        case "closeFeedbackReportIframe":
                            {
                                ...
                                ye || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                pr("".concat(i, "-fr"));
                                break
                            }
                        case "tokenExpired":
                            {
                                var ne, he = a.token;
                                t.isExpired = !0,
                                (ne = t.cbExpired) === null || ne === void 0 || ne.call(t, he),
                                t.params["refresh-expired"] === $.AUTO && !t.isResetting && f(i);
                                break
                            }
                        case "interactiveTimeout":
                            {
                                ...
                                Nt(i);
                                var ue = t.cbTimeout;
                                if (ue ? ue() : t.params["refresh-timeout"] === ie.NEVER && !t.isResetting && b("The widget encountered an interactive timeout and is set to never refresh. Consider defining a timeout handler and resetting the widget upon timeout as solving a widget in a timed-out state is going to fail."),
                                t.params["refresh-timeout"] === ie.AUTO && !t.isResetting) {
                        ...
                        case "interactiveBegin":
                            {
                                ...
                                Ce || m("Cannot layout widget, Element not found (#".concat(i, ")."), 3076),
                                (be = t.cbBeforeInteractive) === null || be === void 0 || be.call(t),
                                t.params.appearance === X.INTERACTION_ONLY && kt(Ce, t);
                                break
                            }
                        case "interactiveEnd":
                            {
                        ...
                        case "requestExtraParams":
                            {
                                ...
                                G || m("Received state for an unknown widget: ".concat(a.widgetId), 3078),
                                t.isResetting = !1;
                                var Qe = {}
                                  , we = W()
                                  , Q = {
        ...
        function R(_) {
            if (typeof _ == "string") {
                var a = ze(_);
                if (a && y.widgetMap.has(a))
                    return a;
                if (y.widgetMap.has(_))
                    return _;
                try {
        ...
        return nt(Fe({}, I), {
            ready: function(a) {
                if (y.scriptWasLoadedAsync && (b("turnstile.ready() would break if called *before* the Turnstile api.js script is loaded by visitors."),
                m("Remove async/defer from the Turnstile api.js script tag before using turnstile.ready().", 3857)),
                typeof a != "function" && m('turnstile.ready() expected a "function" argument, got "'.concat(typeof a == "undefined" ? "undefined" : D(a), '"'), 3841),
                y.isReady) {
                    a();
                    return
                }
            ...
            execute: function(a, i) {
                ...
                if (!t) {
                    ...
                    var d = O(a, i);
                    d || m("Failed to render widget", 43522),
                    t = d
                }
                ...
                if (s) {
                    ...
                    if (s.response) {
                        var x;
                        s.isExecuting = !1,
                        b("Call to execute() on a widget that was already executed (".concat(v, "), execute() will return the previous token obtained. Consider using reset() before execute() to obtain a fresh token.")),
                        (x = s.cbSuccess) === null || x === void 0 || x.call(s, s.response, !1);
                        return
                    }
                    s.isExpired && b("Call to execute on a expired-widget (".concat(v, "), consider using reset() before.")),
                    s.isStale && (f(v),
                    s.isExecuting = !0),
                    s.msgQueue.push(oe.EXECUTE),
                    s.isExecuted = !0;
                    var w = s.shadow.querySelector("#".concat(v));
                    if (w || (s.isExecuting = !1,
                    m("Widget ".concat(v, " to execute was not found"), 43522)),
                    s.isResetting)
                        return;
                    if (s.isInitialized && h(s, t, w),
                    s.isInitialized && s.params.appearance === X.EXECUTE && kt(w, s),
                    s.isExecuting) {
                        var A, S = s.shadow.querySelector("#".concat(v));
                        S || m("Received state for an unknown widget: ".concat(t), 3078),
            ...
            getResponse: function(a) {
                ...
                if (typeof a == "undefined") {
                    ...
                    if (t) {
                        ...
                        return s != null && s.isExpired && b("Call to getResponse on a widget that expired, consider refreshing the widget."),
                        (d = y.widgetMap.get(t)) === null || d === void 0 ? void 0 : d.response
                    } else
                        m("Could not find a widget", 43794)
                }
                var v = R(a);
                return v || m("Could not find widget for provided container", 43778),
                (i = y.widgetMap.get(v)) === null || i === void 0 ? void 0 : i.response
            },
    ...
    function Br(e) {
        ...
        if (l && (ft(l) ? n.size = l : b('Unknown data-size value: "'.concat(l, '".'))),
        0)
            var g;
        ...
        i ? (Qt(i) || b('Invalid data-feedback-enabled value: "'.concat(i, ", expected either: 'true' or 'false'. Value is ignored.")),
        n["feedback-enabled"] = i === "true") : n["feedback-enabled"] = !0;
        ...
        return x && (gt(x) ? n.appearance = x : b('Unknown data-appearance value: "'.concat(x, ", expected either: 'always', 'execute', or 'interaction-only'."))),
        n
    }
    function jr() {
        var e = !0;
        Ct(y, e),
        y.msgHandler && window.removeEventListener("message", y.msgHandler),
        yr(window.turnstile, y)
    }
    ve = !1,
    C = fr(),
    y.scriptWasLoadedAsync = (Ge = C == null ? void 0 : C.loadedAsync) !== null && Ge !== void 0 ? Ge : !1,
    y.scriptUrl = (Xe = C == null ? void 0 : C.src) !== null && Xe !== void 0 ? Xe : "undefined",
    C != null && C.params && (me = C.params.get("compat"),
    (me == null ? void 0 : me.toLowerCase()) === "recaptcha" ? window.grecaptcha ? b("grecaptcha is already defined. The compatibility layer will not be enabled.") : (b("Compatibility layer enabled."),
    y.isRecaptchaCompatibilityMode = !0,
    window.grecaptcha = Ft) : me !== null && b('Unknown value for api.js?compat: "'.concat(me, '", ignoring.')),
    C.params.forEach(function(e, r) {
        M(["onload", "compat", "_cb", "_upgrade", "_reload", "render"], r) || b('Unknown parameter passed to api.js: "?'.concat(r, '=...", ignoring.'))
    }),
    ve = C.params.get("_upgrade") === "true",
    z = C.params.get("onload"),
    z && !ve && setTimeout(function() {
        typeof window[z] == "function" ? window[z]() : (b("Unable to find onload callback '".concat(z, "' immediately after loading, expected 'function', got '").concat(D(window[z]), "'.")),
        setTimeout(function() {
    ...
    Lt && !ve ? b("Turnstile already has been loaded. Was Turnstile imported multiple times?") : (Lt && ve && (hr(window.turnstile, y),
    Ot(y),
    (C == null || (Ye = C.params) === null || Ye === void 0 ? void 0 : Ye.get("render")) !== "explicit" && setTimeout(Mt, 0)),
    window.turnstile = Ft,
    ve || ((C == null || (Ke = C.params) === null || Ke === void 0 ? void 0 : Ke.get("render")) !== "explicit" && Ut.push(Mt),
    document.readyState === "complete" || document.readyState === "interactive" ? setTimeout(_r, 0) : window.addEventListener("DOMContentLoaded", _r))),
    xr = 24 * 60 * 60 * 1e3,
    window.setTimeout(jr, xr);
